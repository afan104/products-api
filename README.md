...
- `internal/controllers` folder - contains all the controllers for each of the 5 endpoints. The controller receives the request, optionally performs and action, and returns a response. In this case, the controllers are:
